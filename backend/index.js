...
app.use(cors({
    origin: 'https://booking-app-frontend-one.vercel.app', // Remove trailing slash
...
app.options('*', (req, res) => {
    res.setHeader('Access-Control-Allow-Origin', 'https://booking-app-frontend-one.vercel.app');
