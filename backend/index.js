...
app.use(cors({
    origin: 'https://booking-app-backend-navy.vercel.app', // Remove trailing slash
...
app.options('*', (req, res) => {
    res.setHeader('Access-Control-Allow-Origin', 'https://booking-app-backend-navy.vercel.app');
